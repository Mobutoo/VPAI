...
| `2026.3.13-1` | 2026-03-15 | Remplace | Tag Docker = `2026.3.13-1` (recovery release). WebSocket origin validation (3.11), workspace plugin auto-load disabled (3.12), plugin-sdk bundling fix (3.13), Chrome DevTools MCP attach, `OPENCLAW_TZ` env — alerte memoire relevee 768→1200MB |
| `2026.4.14` | 2026-04-16 | Remplace | Upgrade audit 2026-04-16 — fix zombie sbx (archiveAfterMinutes 90→30), heap 1024MB — alertes memoire periodiques "update available" quotidiennes via Telegram |
| `2026.4.23` | 2026-04-26 | **Actuelle** | 9 patches — pas de breaking changes connus |
