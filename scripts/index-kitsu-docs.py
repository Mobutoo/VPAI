#!/usr/bin/env python3
"""Index Kitsu documentation into Qdrant via LiteLLM embeddings.

Usage:
    python scripts/index-kitsu-docs.py

Reads docs/kitsu-docs-scraped.md, chunks by section (## headers),
generates embeddings via LiteLLM, and upserts into Qdrant collection 'kitsu-docs'.
"""
import hashlib
import json
import os
...
# --- Configuration ---
DOCS_PATH = os.path.join(os.path.dirname(__file__), "..", "docs", "kitsu-docs-scraped.md")
