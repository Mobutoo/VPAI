...
MODELS = [
    ...
    {"node": "Kling25TurboPro_fal", "name": "Kling 2.5 Turbo Pro",
     "tasks": ["video_preview", "txt2vid", "img2vid"], "quality": 9, "speed": "fast",
     "cost": 0.10, "budget": "balanced", "provider": "kuaishou",
     "notes": "Fastest Kling, great for preview clips. Best value in video gen."},
    ...
    # March 2026 benchmarks: Kling 3.0 = best value, Seedance = best creative control
    {"node": "Kling26Pro_fal", "name": "Kling 2.6 Pro",
     "tasks": ["video_production", "txt2vid"], "quality": 10, "speed": "medium",
     "cost": 0.15, "budget": "balanced", "provider": "kuaishou",
     "notes": "4K capable, excellent motion. Kling = best value in video gen 2026."},
    {"node": "SeedanceTextToVideo_fal", "name": "Seedance 2.0 Text2Video",
     "tasks": ["video_production", "txt2vid", "creative_control"], "quality": 9, "speed": "medium",
     "cost": 0.10, "budget": "eco", "provider": "bytedance",
     "notes": "12-file multimodal input, best creative control, punches above its price."},
    {"node": "KlingMaster_fal", "name": "Kling Master (3.0 tier)",
     "tasks": ["video_production", "video_cinematic", "txt2vid", "long_video", "4k_video"],
     "quality": 10, "speed": "medium", "cost": 0.20, "budget": "balanced", "provider": "kuaishou",
     "notes": "Kling 3.0 tier — 4K/60fps, best character consistency, best value 2026."},
    {"node": "Veo31Fast_fal", "name": "Veo 3.1 Fast",
     ...
     "notes": "Veo 3.1 Fast — native audio, 720p-1080p. Good but expensive vs Kling."},
    ...
    {"node": "KlingOmniImageToVideo_fal", "name": "Kling Omni i2v (3.0)",
     "tasks": ["img2vid", "keyframe_to_clip"], "quality": 10, "speed": "medium",
     "cost": 0.15, "budget": "balanced", "provider": "kuaishou",
     "notes": "Best i2v 2026 — 4K native, best character consistency, preserves source perfectly."},
    ...
    {"node": "SeedanceImageToVideo_fal", "name": "Seedance 2.0 i2v",
     "tasks": ["img2vid", "keyframe_to_clip", "camera_control"], "quality": 9, "speed": "medium",
     "cost": 0.08, "budget": "eco", "provider": "bytedance",
     "notes": "Camera control in i2v, 12-file multimodal. Best value i2v."},
